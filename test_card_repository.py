...
class CardRepositoryTestCase(unittest.TestCase):
    ...
    def setUp(self, mock_input):
        self.card_repository = CardRepository(self.db_file)
        self.card_repository.create_table()
    ...
    def test_get_cards(self, mock_input):
        ...
        self.assertEqual(cards[0].pan, "1111111111111112")
        self.assertEqual(cards[1].pan, "2222222222222223")
    ...
    def test_get_card_by_pan(self, mock_input):
        ...
        self.assertEqual(retrieved_card.user_id, card.user_id)
